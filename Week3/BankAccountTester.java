...
public class BankAccountTester {
    ...
    public static void main(String[] args) {
        // BankAccount shyanneChecking = new BankAccount();
        // BankAccount bobChecking = new BankAccount(10000);

        // System.out.println(shyanneChecking.getBalance());
        ...
        // // shyanneChecking.monthlyFee();

        // System.out.println(shyanneChecking.getBalance());
        
        // shyanneChecking.deposit(50000);
        // shyanneChecking.calcInterest(shyanneChecking.getBalance(), 10, 0.40, 12);
